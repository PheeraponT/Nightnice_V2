...
function ShareButton({ platform, url, text }: ShareButtonProps) {
  ...
  const colors = {
    facebook: "hover:text-[#1877F2] hover:bg-[#1877F2]/10 hover:border-[#1877F2]/30",
    twitter: "hover:text-surface-light hover:bg-white/10 hover:border-white/20",
    line: "hover:text-[#00B900] hover:bg-[#00B900]/10 hover:border-[#00B900]/30",
  };
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className={`w-11 h-11 rounded-xl bg-night/50 border border-white/10 flex items-center justify-center text-muted ${colors[platform]} transition-all duration-200 cursor-pointer`}
