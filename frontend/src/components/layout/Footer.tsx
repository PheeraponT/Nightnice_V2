...
export function Footer() {
  ...
  return (
    <footer className="bg-darker border-t border-muted/20">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <Link
              href="/"
              className="flex items-center gap-2 text-xl font-bold text-gradient mb-4"
            >
              <svg
            ...
            <p className="text-sm text-muted mb-4">{SITE_DESCRIPTION}</p>
          ...
          {/* Categories */}
          <div>
            <h3 className="text-sm font-semibold text-surface-light mb-4">
              หมวดหมู่
            </h3>
