        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PackageInterest = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoogleMapUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    ...
                    PriceRange = table.Column<short>(type: "smallint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetProvinces = table.Column<List<Guid>>(type: "uuid[]", nullable: false),
                    TargetCategories = table.Column<List<Guid>>(type: "uuid[]", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AdMetrics_Advertisements_AdId",
                        column: x => x.AdId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdMetrics_AdId",
                table: "AdMetrics",
                column: "AdId");

            migrationBuilder.CreateIndex(
                name: "IX_AdMetrics_AdId_EventType",
                table: "AdMetrics",
                columns: new[] { "AdId", "EventType" });

            migrationBuilder.CreateIndex(
                name: "IX_AdMetrics_CreatedAt",
                table: "AdMetrics",
                column: "CreatedAt");
